...
void connexion(void)
{
    ...
    usleep(600000);
    system("clear");
    std::cout << BOLD << UNDERLINE << "Basic Python Algorithms" << RESET << std::endl
              << std::endl;
...
{
    // Python ExamShell: only Student part available
    std::string choice = "";
    while (choice != "1")
    {
        system("clear");
        std::cout << WHITE << BOLD << "    Basic Python Algorithms" << RESET << std::endl << std::endl;
        std::cout << LIME << BOLD << "            1" << RESET << std::endl;
        std::cout << WHITE << BOLD << "    | Basic Python Algorithms |" << RESET << BOLD << std::endl
                  << "     \\ -------------------- /" << std::endl
                  << std::endl;
        std::cout << LIME << BOLD << "            2" << RESET << std::endl;
        std::cout << WHITE << BOLD << "    |    SETTINGS PART       |" << RESET << BOLD << std::endl
                  << "     \\ -------------------- /" << std::endl
                  << std::endl;
...
{
    // Python ExamShell: only rank02 available
    return (2);
}

// ==> Piscine menu (not used in Python ExamShell)
